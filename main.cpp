...
void DrawSquare(double x, double y, double width, double height, double r, double g, double b)
{
	...
	verts.push_back({{x			, y + height}, {r, g, b}, {0.0f, 1.0f}});
	verts.push_back({{x + width	, y			}, {r, g, b}, {1.0f, 0.0f}});
	verts.push_back({{x + width	, y + height}, {r, g, b}, {1.0f, 1.0f}});
	verts.push_back({{x			, y			}, {r, g, b}, {0.0f, 0.0f}});
